...
const ListUsers = () => {
    ...
    return <div>
        <Box sx={{ display: 'flex', margin: '50px 0px', justifyContent: 'space-between' }}>
            <TextField id="outlined-basic" label="FullName" variant="outlined" size="small"
                value={nameSearch}
                onChange={(e) => { handleSearchFullName(e.target.value) }}
            />
            <TextField id="outlined-basic-2" label="Email" variant="outlined" size="small"
                value={email}
        ...
        <TableContainer component={Paper} sx={{ minHeight: 322 }}>
                ...
                <TableBody>
                    {usersData.map((item, i) => (
                        ...
                        >
                            ...
                            <TableCell color='' align="center">{item.firstName}</TableCell>
